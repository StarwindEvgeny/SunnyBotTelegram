...
class RestOutside: MakeResponse() {
    override val IMAGE_DIR: String = "/home/evgeny/docks/Image/RestOutside.png"

    override val CAPTION: String = "Блок предохранителей в моторном отсеке FB15 рестайлинг 8N200.\n" +
            "\n" +
            "\n" +
