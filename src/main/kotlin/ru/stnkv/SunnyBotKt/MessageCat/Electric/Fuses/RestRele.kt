...
class RestRele: MakeResponse() {
    override val IMAGE_DIR: String = "/home/evgeny/docks/Image/RestRele.png"

    override val CAPTION: String = "Блок реле в моторном отсеке FB15 рестайлинг 8N060.\n" +
            "\n" +
            "\n" +
