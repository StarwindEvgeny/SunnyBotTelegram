...
class ManualDiag: MakeResponse() {
    override val IMAGE_DIR: String = "/home/evgeny/docks/Image/ManualDiagnostic.jpg"
    override val CAPTION: String = "Для того что бы прочитать код неисправности делаем следующее:\n" +
            "\n" +
