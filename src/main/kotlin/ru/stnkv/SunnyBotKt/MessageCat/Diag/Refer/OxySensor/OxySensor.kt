...
class OxySensor: MakeResponse() {
    override val IMAGE_DIR: String = "/home/evgeny/docks/Image/OxygenSensor.jpg"
    override val CAPTION: String = "Процедуру замера рекомендуется проводить на <u>ПОЛНОСТЬЮ</u> прогретом автомобиле <u>БЕЗ ПОТРЕБИТЕЛЕЙ.</u>\n" +
            "\n" +
            "\n" +
