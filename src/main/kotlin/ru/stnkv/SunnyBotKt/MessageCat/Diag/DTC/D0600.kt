...
class D0600: MakeResponse() {
    override val CAPTION: String = "Ошибка P0600 указывает на наличие неисправности, связанной с каналом связи модуля управления двигателем (ECM).\n" +
            "\n" +
