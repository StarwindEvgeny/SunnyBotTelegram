package ru.stnkv.SunnyBotKt.MessageCat.Elctric.EFI

import org.telegram.telegrambots.meta.api.objects.replykeyboard.InlineKeyboardMarkup
import org.telegram.telegrambots.meta.api.objects.replykeyboard.buttons.InlineKeyboardButton
import ru.stnkv.SunnyBotKt.MakeResponse

class EFI: MakeResponse() {
    override val IMAGE_DIR: String = "/home/evgeny/docks/Image/EFI.jpg"
    override val CAPTION: String = "Для верного выбора блока управления обратите внимание на прошивку блока (обведено красным) \n" +
            "\n" +
