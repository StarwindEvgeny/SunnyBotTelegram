...
class D0400 {
    companion object {
        const val CAPTION: String =
            "Ошибка P0400 в автомобиле Nissan означает неисправность потока рециркуляции отработавших газов (неисправность контроля системы улавливания паров бензина).\n" +
                    "\n" +
                    "Возможные причины:\n" +
                    "\n" +
