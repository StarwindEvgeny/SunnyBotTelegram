...
class VAGCOM {
    companion object {
        const val IMAGE_DIR: String = "/home/evgeny/docks/Image/VAGCOMKKL.jpg"
        ...
        fun getMenu(): InlineKeyboardMarkup {
            ...
            row2Button1.url =
                "https://www.ozon.ru/category/testery-avtomobilnye-8663/?category_was_predicted=true&deny_category_prediction=true&from_global=true&text=VAG+COM+FTDI"
