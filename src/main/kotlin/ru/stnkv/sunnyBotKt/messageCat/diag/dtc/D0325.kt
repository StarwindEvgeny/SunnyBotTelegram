...
class D0325 {
    companion object {
         const val CAPTION: String =
            "Ошибка P0325 относится к датчику детонации на блоке 1 двигателя. Она означает, что датчик не посылает правильные сигналы на контроллер. Это может происходить по разным причинам: от плохой проводки до неисправного датчика.\n" +
                    "\n" +
