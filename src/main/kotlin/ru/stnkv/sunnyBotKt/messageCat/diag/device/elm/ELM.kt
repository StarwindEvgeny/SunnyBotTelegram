...
class ELM {
    companion object {
        const val CAPTION: String = "Компактное устройство, которое удобно возить с собой.\n" +
                "\n" +
        ...
        const val IMAGE_DIR: String = "/home/evgeny/docks/Image/ELM327.jpg"
        ...
        fun getMenu(): InlineKeyboardMarkup {
            ...
            row3Button1.url =
                "https://yandex.ru/search/?text=elm327+1.5+pic18f25k80&lr=11314&clid=2360950&win=650&src=suggest_T"
