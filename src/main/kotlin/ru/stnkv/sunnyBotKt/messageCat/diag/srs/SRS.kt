...
class SRS {
    companion object {
        const val IMAGE_DIR: String = "/home/evgeny/docks/Image/SRSDiagnostic.jpg"

        const val CAPTION: String =
            "<i>Процедура диагностики системы безопасности автомобиля без специального оборудования.</i>"
